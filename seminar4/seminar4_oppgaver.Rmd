...
`perinc` som uavhengige variabler. Lagre modellen som et objekt. Tolk koeffesienten til `beertax`. 
...
`perinc` og `state_fac` som uavhengige variabler. Lagre modellen som et objekt. Tolk koeffesienten til `beertax`. (P.S.:
...
11. Hva er gjennomsnitt og median til variabelen beertax? Vis hvordan du kommer frem til det via kode og oppgi verdiene i en kommentar. 
